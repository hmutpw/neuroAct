setGeneric("neuronActivity", function(x, ...) standardGeneric("neuronActivity"))
#' Performing activity evaluation
#'
#'
#' @param x An object with gene expression data used for neuron activity evaluation,
...
#'
#' @export
setMethod("neuronActivity", "matrix", function(x,
                                               gene_list,
                                               method = c("ssgsea","gsva","aucell","zscore", "plage","viper"),
                                               normalization = TRUE,
                                               min_target_num = 5,
                                               max_target_num = 500,
                                               norm_act = FALSE,
  ...
  if(method == "aucell"){
    ...
    stop("Current version of 'neuronActivity()' only support 6 methods!")
  }
  if(norm_act){
